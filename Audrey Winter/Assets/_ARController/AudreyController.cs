...
namespace GoogleARCore.Examples.HelloAR {
    ...
    public class AudreyController : MonoBehaviour {
        ...
        //Audrey prefab
        //public GameObject Audrey;

        //Spawn points
        Transform spawnAudrey;

        //Has the stage been placed?
        bool placeModel = false;
        //Have characters been spawned?
            ...
            while (currentstate == GAME_STATE.STARTING) {                            
                ...
                if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit)) {
                    ...
                    if ((hit.Trackable is DetectedPlane) &&
                        ...
                        StageInstance.transform.Rotate(0, k_ModelRotation, 0, Space.Self);
                        ...
                        //StartCoroutine(SpawnPlayers());      //GOOFY
                        //allPlayersSpawned.Value = true;

                        //if (allPlayersSpawned.Value == true && placeModel) {
        ...
        IEnumerator SpawnPlayers() {
            ...
            spawnAudrey = GameObject.FindGameObjectWithTag("SpawnAudrey").transform;
            //Kyle = GameObject.FindGameObjectWithTag("enemySpawn").transform;

            Vector3 cameraPositionSameY = FirstPersonCamera.transform.position;

            //var playerInstance = Instantiate(Audrey, spawnAudrey.transform.position, Quaternion.LookRotation(this.transform.position - m_RedSpawn.transform.position));        
            //var playerInstance = Instantiate(Audrey, spawnAudrey.transform.position, Quaternion.identity);
